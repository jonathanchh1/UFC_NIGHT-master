...
public class FightersAdapters extends RecyclerView.Adapter<FightersAdapters.FightersViewHolder> {
    ...
    public FightersAdapters(List<Fighters> fighters, int rowLayout, Context context, Callbacks mCallbacks) {
    ...
    @NonNull
    @Override
    public FightersAdapters.FightersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new FightersAdapters.FightersViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull final FightersAdapters.FightersViewHolder holder, final int position) {
