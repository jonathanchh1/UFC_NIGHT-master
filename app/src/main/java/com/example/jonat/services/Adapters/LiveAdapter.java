...
public class LiveAdapter extends RecyclerView.Adapter<LiveAdapter.UFCViewHolder> implements Filterable {
    ...
    public LiveAdapter(List<Events> events, int rowLayout, Context context, Callbacks mCallbacks) {
    ...
    @Override
    public LiveAdapter.UFCViewHolder onCreateViewHolder(ViewGroup parent,
                                                        int viewType) {
