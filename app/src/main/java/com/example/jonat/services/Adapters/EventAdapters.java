...
public class EventAdapters extends RecyclerView.Adapter<EventAdapters.UFCViewHolder> implements Filterable {
    ...
    public EventAdapters(List<Events> events, int rowLayout, Context context, Callbacks mCallbacks) {
    ...
    @Override
    public EventAdapters.UFCViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
